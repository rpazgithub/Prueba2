...
class ProyectoEmpresarial(models.Model):
    ...
    persona_contacto = models.ForeignKey('self', on_delete = models.CASCADE, null = True, related_name='+',  verbose_name = 'Persona contacto:')
...
class InformacionContactoEmpresa(models.Model):
    ...
    pais_id = models.ForeignKey('self', on_delete = models.CASCADE, null = True, related_name='+', verbose_name = 'Id. Pais:', help_text = 'Seleccione una identificación para el pais')
    departamento_id = models.ForeignKey('self', on_delete = models.CASCADE, null = True, related_name='+', verbose_name = 'Id. Departamento:', help_text = 'Seleccione una identificación para el departamento')
    municipio_id = models.ForeignKey('self', on_delete = models.CASCADE, null = True, related_name='+', verbose_name = 'Id. Municipio:', help_text = 'Seleccione una identificación para el municipio')
    division_territorial_id = models.ForeignKey('self', on_delete = models.CASCADE, null = True, related_name='+', verbose_name = 'Id. Division territorial:', help_text = 'Seleccione una identificación para la division territorial')
    barrio_id = models.ForeignKey('self', on_delete = models.CASCADE, null = True, related_name='+', verbose_name = 'Id. Barrio:', help_text = 'Seleccione una identificación para el barrio')
...
class Integrante(models.Model):
    ...
    profesion = models.ForeignKey('self', on_delete = models.CASCADE, null= True, related_name='+', verbose_name = 'Profesión:')
    ocupacion = models.ForeignKey('self', on_delete = models.CASCADE, null = True, related_name='+', verbose_name = 'Ocupación:')
    nivel_estudio_id = models.ForeignKey('self', on_delete = models.CASCADE, null = True, related_name='+', verbose_name = 'Id. Nivel de estudio:', help_text = 'Seleccione una identificacion para el nivel de estudios')
